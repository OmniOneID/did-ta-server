...
TA 서버 Repository에 오신 것을 환영합니다. <br>
이 Repository는 TA 서버의 소스 코드, 문서, 관련 리소스를 포함하고 있습니다.
...
- **TA API**: TA 서버의 API 엔드포인트 및 사용법에 대한 자세한 참고 자료입니다.
  - [TA API 참고 자료](docs/api/TAS_API_ko.md)
