...
| v1.0.1 | 2025-04-24 | TA 등록 절차 업데이트, Entity 메뉴 구조 수정, User 관리 메뉴 추가 |
...
![메인 화면 구성](./images/2-1.main-screen.png)
...
![TA 미등록 상태 사이드바](./images/2-2.side-menu-before-registration.png)
<style scoped>
img {
  width: 20%;
  height: auto;
...
![TA 등록 완료 사이드바](./images/2-3.side-menu-after-registration.png)
<style scoped>
img {
  width: 12%;
  height: auto;
...
![TA 등록 Step1](./images/3-1-1.ta-registration.png)
...
![TA 등록 Step2](./images/3-1-2.ta-registration.png)
<style scoped>
img {
  width: 30%;
  height: auto;
...
![TA 등록 Step3-1](./images/3-1-3.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA 등록 Step3-2](./images/3-1-4.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA 등록 Step3-2 등록 완료](./images/3-1-5.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA 등록 Step4-1](./images/3-1-6.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA 등록 Step4-2](./images/3-1-7.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA 등록 완료 화면](./images/3-1-8.ta-registration.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![TA Management 화면](./images/3-2.ta-management.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
Entity Management 메뉴에 진입하면, Open DID에 등록된 Entity 목록이 테이블 형태로 표시됩니다.

![Entity 목록 조회 화면](./images/3-3.entity-management-main.png)
<style scoped>
img {
  width: 50%;
  height: auto;
...
![Entity QUICK REGISTER 이후 화면](./images/3-4.entity-management-after-quick-registeration.png)
<style scoped>
img {
  width: 70%;
  height: auto;
...
![Entity 상세 정보 화면](./images/3-6.entity-detail-information.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![KYC Settings 화면](./images/3-7.kyc-settings.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Expiration Settings 화면](./images/3-8.expiration-settings.png)
<style scoped>
img {
  width: 35%;
  height: auto;
...
![Email Server Settings 화면](./images/3-10.email-server-settings.png)
<style scoped>
img {
  width: 23%;
  height: auto;
...
![Email Template Settings 화면](./images/3-11.email-template-settings.png)
<style scoped>
img {
  width: 30%;
  height: auto;
...
![Push Server Settings 화면](./images/3-12.push-server-settings.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Allowed CA Management 메인화면](./images/3-13.allowed-ca-management-main.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Allowed CA 등록화면](./images/3-14.allowed-ca-registration.png)
<style scoped>
img {
  width: 20%;
  height: auto;
...
![Allowed CA 상세화면](./images/3-15.allowed-ca-detail.png)
<style scoped>
img {
  width: 30%;
  height: auto;
...
![Allowed CA 수정화면](./images/3-16.allowed-ca-update.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![VC Schema 목록 화면](./images/3-17.vc-schema-management-main.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![VC Schema 상세 화면](./images/3-18.vc-schema-detail.png)
<style scoped>
img {
  width: 25%;
  height: auto;
...
![VC Plan 목록 화면](./images/3-19.vc-plan-managemnet.png)
<style scoped>
img {
  width: 30%;
  height: auto;
...
![VC Plan 상세 화면](./images/3-20.vc-plan-detail.png)
<style scoped>
img {
  width: 23%;
  height: auto;
...
![User 목록 화면](./images/3-23.user-list.png)
<style scoped>
img {
  width: 23%;
  height: auto;
...
![User 상세 화면](./images/3-24.user-detail.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![App 목록 화면](./images/3-25.app-list.png)
<style scoped>
img {
  width: 30%;
  height: auto;
...
![App 상세 화면](./images/3-26.app-detail.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Wallet 목록 화면](./images/3-27.wallet-list.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Wallet 상세 화면](./images/3-28.wallet-detail.png)
<style scoped>
img {
  width: 40%;
  height: auto;
...
![Admin 목록 화면](./images/3-21.admin-management.png)
<style scoped>
img {
  width: 60%;
  height: auto;
...
![Admin 등록 화면](./images/3-22.admin-registration.png)
<style scoped>
img {
  width: 50%;
  height: auto;
