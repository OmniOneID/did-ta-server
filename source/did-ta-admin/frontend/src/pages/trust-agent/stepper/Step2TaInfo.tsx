    ...
    <>
      ...
      <StyledDescription>
        <Typography variant="body1">
          Please enter the name and URL of the Trust Agent (TA).
        </Typography>
        ...
        <Typography variant="body1" sx={{ mt: 1 }}>
          <strong>Note:</strong> The Trust Agent server and Admin Console currently use the same base URL,  
