...
import org.omnione.did.list.v1.admin.service.ListCredentialSchemaManagementService;
...
public class ListCredentialSchemaManagementController {
    private final ListCredentialSchemaManagementService listCredentialSchemaManagementService;

    @GetMapping(value = "/credential-schemas/list")
    public Page<ListCredentialSchemaDto> searchAllowedCredentialSchemaList(String searchKey, String searchValue, Pageable pageable) {
        return listCredentialSchemaManagementService.searchCredentialSchemaList(searchKey, searchValue, pageable);
    }

    @GetMapping(value = "/credential-schemas")
    public ListCredentialSchemaDto getCredentialSchema(Long id){
        return listCredentialSchemaManagementService.findById(id);
    }
