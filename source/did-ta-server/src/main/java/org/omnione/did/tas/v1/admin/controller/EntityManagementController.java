...
public class EntityManagementController {
    ...
    @GetMapping(value = "/entities/roles/{role}")
    public List<EntityInfoDto> findEntitiesByRole(@PathVariable("role") String role) {
        return entityManagementService.findEntitiesByRole(role);
    }
