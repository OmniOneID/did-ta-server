# TA Server Source Code

Welcome to the TA Server source code repository. This directory contains the core source code and build configurations for the TAS Server.
...
| Name          | Description                                  |
| ------------- | -------------------------------------------- |
| did-ta-server | TA Server source code and build files        |
...
- [OpenDID TA Server Installation and Operation Guide](../../docs/installation/OpenDID_TAServer_Installation_Guide.md)  
